  ...
  return (
    <div className="bg-[#111827]">
        ...
        <div className="dark:text-white flex flex-col relative">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-3">{productName}</h2>
          ...
          <h3 className="absolute bottom-[60px] text-2xl font-bold text-gray-900 dark:text-white mb-6">R$ {price}</h3>
          <Button
            href="#"
